...
{
$del_id=$_GET['del'];
$del_query="DELETE FROM `pas`.`wash` WHERE `wash`.`sr_no` = $del_id";	
...
<head>
    ...
    <!-- Title Page-->
    <title>Admin View Washing Appointment</title>
...
<td>
 ...
 <td>
 <a href="washing_appointment.php?del= <?php echo $aid4; ?>"> <span class="fa fa-times" ></span></a>
 </td>
...
<?php } ?>
                        ...
                        <div class="row" style="padding-top:14%">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2022. All rights reserved. Template by <a href="../index.php">PAS</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>

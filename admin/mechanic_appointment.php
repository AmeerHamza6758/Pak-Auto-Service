...
{
$del_id=$_GET['del'];
$del_query="DELETE FROM `pas`.`mechanicbooking` WHERE `mechanicbooking`.`sr_no` = $del_id";	
...
<head>
    ...
    <!-- Title Page-->
    <title>Admin View Mechanic Appointment</title>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive m-b-40">
                                    <table class="table table-borderless table-data3">
										...
										<?php
$query="SELECT * FROM mechanicbooking";
...
<td>
 ...
 <td>
 <a href="mechanic_appointment.php?del= <?php echo $aid4; ?>"> <span class="fa fa-times" ></span></a>
 </td>

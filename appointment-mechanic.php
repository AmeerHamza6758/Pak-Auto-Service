...
$inserted = "INSERT INTO `mechanicbooking`(`username`, `service`, `type`, `number`, `date`, `time`, `name`, `email`, `phone`, `message`) VALUES ('$user','$service', '$make', '$number', '$date', '$time','$name','$email','$phone','$message')" ;
          ...
          <div class="appointment-block">
            <form id="appointment-form" class="appointment-form" method="post" action=" ">                            
              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="dropdown">
                    <button class="btn btn-dropdown dropdown-toggle" type="button" id="service-type" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                      <span class="drp-name" data-bind="label">Choose Appointment Type</span>
                      <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu service-type" aria-labelledby="service-type" name="service-type">
                      <li value="Engine Work"><a href="#">Engine Work</a></li>
                      <li value="Oil Change"><a href="#">Oil Change</a></li>
                      <li value="Change Parts"><a href="#">Change Parts</a></li>
                      <li value="Electric Work"><a href="#">Eletric Work</a></li>
                    </ul>
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="number" id="vehical-model" placeholder="Enter Vehicle Number" required>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6">
            <div class="footer-about footer-widget">
              ...
              <p>Auto Sense car services is the premier mobile detailing service in Rahim Yar Khan.</p>              
            </div>
          </div>
          <div class="col-md-3 col-sm-6">

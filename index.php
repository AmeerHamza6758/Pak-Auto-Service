        ...
        <div class="col-md-6 col-sm-6">
          <div class="top-bar-right">
            ...
            <div class="social-icon">
              <ul>
                <li><a href="page.html" target="_ "><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="section">
            ...
            <p>Pak Auto service is the premier mobile detailing service in Rahim Yar Khan. Our mission is simple, to deliver exceptional automotive detailing services to you our customer while at the same time making it as convenient and time efficient for you as possible all with the lowest possible price.</p>
          </div>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="service-block text-center">
            ...
            <div class="service-dtl">
              ...
              <p>Need to freshen up your vehicle's interior? Eliminate car odors by using services of Pak auto services.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-sm-6">
          ...
          <div class="team-block text-center">
            <div class="team-img">
             ...
             <div class="team-dtl">
              ...
              <div class="team-post">Services Incharge</div>
              <div class="team-social">
                <ul>
                  <li><a href="page.html" target=""><i class="fa fa-facebook"></i></a></li>
          ...
          <div class="team-block text-center">
            <div class="team-img">
             ...
             <div class="team-dtl">
              ...
              <div class="team-post">Online Car Booking Incharge</div>
              <div class="team-social">
                <ul>
